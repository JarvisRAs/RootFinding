...
#                print("!!! DIDNT FIND ANY ROOTS!!")
    ...
    with open('YRoots_New_rand_poly_timings_dim_3.pkl', 'wb') as ofile:
        pickle.dump(timing_dict, ofile)
    
    np.save("YRoots_New_checks_avg_resids_rand_poly_dim_3", all_avg_resids, allow_pickle=True, fix_imports=True)
    np.save("YRoots_New_checks_max_resids_rand_poly_dim_3", all_max_resids, allow_pickle=True, fix_imports=True)
    np.save("YRoots_New_checks_num_roots_rand_poly_dim_3", all_num_roots, allow_pickle=True, fix_imports=True)
